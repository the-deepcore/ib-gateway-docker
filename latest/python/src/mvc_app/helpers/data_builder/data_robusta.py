...
def data_robusta_builder(start_load:str, end_load:str,
    ...
    """
    Build data loader for Robusta coffee strategy.
    ...
    def builder() -> Tuple[Clock, Dict[str, pd.Series]]:
        ...
        if source == DataSource.EXCEL:
            ...
            coffee_fut_cfg = CoffeeFuturesCfg(
                file_name="data_futures_robusta.xlsx",
                key="RBST",
                data_dir="data",
