...
# start_slice, end_slice = "2008-01-14", datetime.today().strftime('%Y-%m-%d')
...
def build_calib_rbst() -> CalibrationConfig:
    ...
    obj = ObjectiveConfig(
        direction="maximize",
        weights={"sharpe": 3.0, "total_return_pct": 0.75, "mdd": 30.0},
        top_k=nb_trials,
    )
...
PROFILE = UseCaseProfile(
    ...
    bench_key = "RBST",
    # wf_json_path=Path("save_wf_simu/wf_rbst_fut_shifted_calibration.json"),
