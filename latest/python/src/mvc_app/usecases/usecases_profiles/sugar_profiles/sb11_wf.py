    ...
    spec = InputSpec(
        ...
        recipes={
            "zscore": {
                "base": "spread",
                "ops": [
                    {"op": "zscore_smooth_ewm", "window": 15, "smooth_span": 5},
                ],
            },
            "vol_sizer": {
                "base": "fut_close",
...
PROFILE = UseCaseProfile(
    ...
    bench_key = "SB11",
    # wf_json_path=Path("save_wf_simu/wf_sb11_calibration.json"),
    wf_json_path=Path("save_wf_simu/calib_temp/sb11_zscore_spot_calibration.json"),
